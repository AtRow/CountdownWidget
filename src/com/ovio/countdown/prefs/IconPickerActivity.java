...
public class IconPickerActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gridView.setOnItemClickListener(iconListener);

        iconAdapter.notifyDataSetChanged();
    }

    private AdapterView.OnItemClickListener iconListener = new AdapterView.OnItemClickListener() {
        @Override
    ...
    private BaseAdapter iconAdapter = new BaseAdapter() {
